...
# 05/21/2021
# title: 02_Mech_Sim_Multi_lifestage
...
pred.df <- pred.df %>%  filter(DOY>=150)
...
fec <- 2.4 ## setting a fecudity rate of 3 eggs per day per female
aMortal <- 0.35 ## setting mortality rate for adults
lMortal <- 0.3 ## setting mortality rate for larvae
